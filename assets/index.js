...
import TelegramFillIcon from 'remixicon-react/TelegramLineIcon'


export const heroIcons = [
  {
    icon: <FacebookCircleLineIcon className='size-7 hover:text-amber-400 transition-all hover:-translate-y-1 active:translate-0' />,
    link: 'https://www.facebook.com/profile.php?id=100010150261486'
  },
  {
    icon: <LinkedinBoxLineIcon className='size-7 hover:text-amber-400 transition-all hover:-translate-y-1 active:translate-0' />,
    link: 'https://www.linkedin.com/in/mohammed-sobhi-gouda-a62284271'
  },
  {
    icon: <GithubLineIcon className='size-7 hover:text-amber-400 transition-all hover:-translate-y-1 active:translate-0' />,
    link: 'https://github.com/MohammedSobhi606'
  },
  {
    icon: <TelegramFillIcon className='size-7 hover:text-amber-400 transition-all hover:-translate-y-1 active:translate-0' />,
    link: "https://t.me/moha2000yahoo"
  }
]
// AboutMe icons
...
export const reviewsData = [
  {
    ...
    name: 'shaban T., Freelance Graphic Designer',
    comment:
  ...
  },
  {
    ...
    name: 'Nagwa R., CEO of Tech Startup',
    comment:
  ...
  },
  {
    ...
    name: 'Ahmed W., Lifestyle Blogger',
    comment:
  ...
  },
  {
    ...
    name: 'Mahmoud H., Director of Non-Profit Organization',
    comment:
